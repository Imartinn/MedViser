...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dbHandler.limpiarBD();
                        RestClient.bajarDelServer(LoginActivity.this);
                    }
                }).start();
            }
        });
        ...
        btnUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        RestClient.subirAlServer(LoginActivity.this);
                    }
                }).start();
            }
        });
    ...
    private void cargarPrevios() {
        ...
        String u = prefs.getString("Puser", "");
        String p = prefs.getString("Ppass", "");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            final String sUser = new String(Hex.encodeHex(DigestUtils.sha1(mEmail)));
            final String sPass = new String(Hex.encodeHex(DigestUtils.sha1(mPassword)));
            ...
            RestClient.post("login.php", entity, new TextHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, String responseString) {
                    SharedPreferences prefs = getSharedPreferences("data", Context.MODE_PRIVATE);
                    prefs.edit().putString("Puser", mEmail).apply();
                    prefs.edit().putString("Ppass", mPassword).apply();
                    prefs.edit().putString("user", sUser).apply();
                    prefs.edit().putString("pass", sPass).apply();
